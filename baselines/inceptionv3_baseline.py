"""
InceptionV3 Baseline — Deep Fake Detection
...
callbacks = [
    ...
    ModelCheckpoint(filepath='model_inceptionv3.keras', monitor='val_loss',
...
plt.savefig('inceptionv3_learning_curves.png', dpi=150, bbox_inches='tight')
plt.show()
...
evaluate_model('model_inceptionv3.keras', test_generator, show_plots=True)
